...
if (realhomes_dashboard_edit_property()) {
	...
	<div class="address-map-fields-wrapper">
		...
		<div class="map-wrapper">
			<div id="map-address-field-wrapper" class="address-wrapper">
				...
				<input type="text" class="required" name="address" id="address" placeholder="כלנית 24"
					value="<?php echo esc_attr($property_address); ?>"
					title="<?php esc_attr_e('* Please provide a property address!', 'framework'); ?>" />
				<input type="text" id="full-address" value="" style="height:0;padding:0;margin:0;box-shadow:none;" />
	...
	<div class="address-map-fields-wrapper">
		<div class="map-wrapper">
			<div id="map-address-field-wrapper" class="address-wrapper">
				<label for="address"><?php echo esc_html($property_address_label); ?></label>
				<input type="text" class="required map-address" name="address" id="address" placeholder="כלנית 24"
