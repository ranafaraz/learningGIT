...
?>
<form id="submit-property-form" class="submit-property-form <?php echo esc_attr($form_class); ?>"
	...
	<div id="dashboard-tabs" class="dashboard-tabs">
		...
		<div id="dashboard-tabs-contents" class="dashboard-tabs-contents">
			...
			<div class="dashboard-tab-content form-fields current-tab-content"
				data-content-title="<?php esc_html_e('Basic', 'framework'); ?>">
				<div class="row">
					<?php
					// Property Title
					...
					?>
					<div class="col-md-6 col-lg-4">
						<?php get_template_part('common/dashboard/form-fields/floor'); ?>
					</div>
					<?php
					...
					?>
					<div class="col-md-6 col-lg-4">
						<?php get_template_part('common/dashboard/form-fields/entry-date'); ?>
					</div>
					<?php
			...
			if (
				in_array('images', $inspiry_submit_fields, true) ||
			...
			if (
				in_array('video', $inspiry_submit_fields, true) ||
			...
			if (
				in_array('features', $inspiry_submit_fields, true) ||
			...
			if (
				in_array('agent', $inspiry_submit_fields, true) ||
				...
				<div class="dashboard-tab-content form-fields"
					data-content-title="<?php esc_html_e('Agent & Reviewer', 'framework'); ?>">
					<div class="row">
						<?php
						// Property Agent
						...
						if ($show_reCAPTCHA) {
							...
							<div class="col-12">
								<div
									class="field-wrap inspiry-recaptcha-wrapper g-recaptcha-type-<?php echo esc_attr(get_option('inspiry_reCAPTCHA_type', 'v2')); ?>">
