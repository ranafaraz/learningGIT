...
(function ($) {
  ...
  var inspiryProfileUploader = function () {
    ...
    $('#remove-profile-image').on('click', function (event) {
      ...
      // Reset the uploader queue to avoid duplicate error
      profileUploader.splice();

      // Optionally, you can reset the uploader's internal state more thoroughly
      profileUploader.refresh();
    });
  };
