...
if ( ! function_exists( 'inspiry_footer_logo_customizer' ) ) {
	...
	function inspiry_footer_logo_customizer( WP_Customize_Manager $wp_customize ) {
		...
		if ( 'ultra' === INSPIRY_DESIGN_VARIATION ) {
			$footer_logo_selector = '.site-footer-logo-wrapper a';
			$tagline_selector     = '.site-footer .tag-line';

		} else {
			$footer_logo_selector = '.rh_footer__logo a';
			$tagline_selector     = '.rh_footer__logo .tag-line .text';
