		...
		<div class="inspiry-clone inspiry-group-clone" data-floor-plan="<?php echo esc_attr($index); ?>">
			<div class="row">
				<div class="col-lg-6">
					<div class="inspiry-field">
						<label
							for="inspiry_floor_plan_name_<?php echo esc_attr($index); ?>"><?php echo esc_html($floor_name_label); ?></label>
						<input type="text" id="inspiry_floor_plan_name_<?php echo esc_attr($index); ?>"
							name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_name]"
							value="<?php echo esc_attr($floor_plan_name); ?>">
					</div>
				</div>
				<div class="col-lg-6">
					<div class="inspiry-field inspiry-file-input-wrapper">
						...
						<div class="inspiry-btn-group clearfix <?php echo esc_attr($inspiry_show_remove_btn); ?>">
							<input type="text" class="inspiry-file-input"
								name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_image]"
								value="<?php echo esc_attr($floor_plan_image); ?>">
							<button id="inspiry-file-select-<?php echo esc_attr($index); ?>"
								class="inspiry-file-select real-btn btn btn-primary"><?php esc_html_e('Select Image', 'framework'); ?></button>
							<button id="inspiry-file-remove-<?php echo esc_attr($index); ?>"
								class="inspiry-file-remove real-btn btn btn-secondary <?php echo esc_attr($inspiry_file_remove_button_class); ?>"><?php esc_html_e('Remove', 'framework'); ?></button>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="inspiry-field">
						<label
							for="inspiry_floor_plan_descr_<?php echo esc_attr($index); ?>"><?php echo esc_html($floor_plan_description_label); ?></label>
						<textarea id="inspiry_floor_plan_descr_<?php echo esc_attr($index); ?>" class="inspiry-textarea"
							name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_descr]"><?php echo esc_attr($floor_plan_descr); ?></textarea>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="row">
						<div class="col-sm-6">
							<div class="inspiry-field">
								<label
									for="inspiry_floor_plan_price_<?php echo esc_attr($index); ?>"><?php echo esc_html($floor_price_label); ?>
									<span><?php esc_html_e('( Only digits )', 'framework'); ?></span></label>
								<input type="text" id="inspiry_floor_plan_price_<?php echo esc_attr($index); ?>"
									name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_price]"
									value="<?php echo esc_attr($floor_plan_price); ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="inspiry-field">
								<label
									for="inspiry_floor_plan_price_postfix_<?php echo esc_attr($index); ?>"><?php echo esc_html($floor_price_postfix_label); ?></label>
								<input type="text" id="inspiry_floor_plan_price_postfix_<?php echo esc_attr($index); ?>"
									name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_price_postfix]"
									value="<?php echo esc_attr($floor_plan_price_postfix); ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="inspiry-field">
								<label
									for="inspiry_floor_plan_size_<?php echo esc_attr($index); ?>"><?php echo esc_html($floor_size_label); ?>
									<span><?php esc_html_e('( Only digits )', 'framework'); ?></span></label>
								<input type="text" id="inspiry_floor_plan_size_<?php echo esc_attr($index); ?>"
									name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_size]"
									value="<?php echo esc_attr($floor_plan_size); ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="inspiry-field">
								<label
									for="inspiry_floor_plan_size_postfix_<?php echo esc_attr($index); ?>"><?php echo esc_html($floor_size_postfix_label); ?></label>
								<input type="text" id="inspiry_floor_plan_size_postfix_<?php echo esc_attr($index); ?>"
									name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_size_postfix]"
									value="<?php echo esc_attr($floor_plan_size_postfix); ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="inspiry-field">
								<label
									for="inspiry_floor_plan_bedrooms_<?php echo esc_attr($index); ?>"><?php echo esc_html($floor_bedrooms_label); ?></label>
								<input type="text" id="inspiry_floor_plan_bedrooms_<?php echo esc_attr($index); ?>"
									name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_bedrooms]"
									value="<?php echo esc_attr($floor_plan_bedrooms); ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="inspiry-field">
								<label
									for="inspiry_floor_plan_bathrooms_<?php echo esc_attr($index); ?>"><?php echo esc_html($floor_bathrooms_label); ?></label>
								<input type="text" id="inspiry_floor_plan_bathrooms_<?php echo esc_attr($index); ?>"
									name="inspiry_floor_plans[<?php echo esc_attr($index); ?>][inspiry_floor_plan_bathrooms]"
									value="<?php echo esc_attr($floor_plan_bathrooms); ?>">
							</div>
						</div>
					</div>
				</div>
	...
	function inspiry_floor_plans()
	{
		...
		<div class="inspiry-floor-plans-group-wrapper">
			...
			<div class="inspiry-add-clone-container">
				<button type="button" id="inspiry-add-clone" class="inspiry-add-clone btn btn-primary"><i
						class="fas fa-plus"></i><?php esc_html_e('Add More', 'framework'); ?></button>
			</div>
		</div>
		<?php
	}
	...
	function inspiry_render_property_attachments()
	{
		...
		<div class="property-attachments-container-wrap">
			...
			<div id="property-attachments-container" class="property-attachments-container">
				...
				<div id="attachments-drag-drop" class="attachments-drag-drop"
					data-max-attachments="<?php echo esc_attr($max_attachments) ?>">
					<div class="attachments-limit"><span
							class="attachments-uploaded"><?php echo esc_html($count_attachments); ?></span>/<?php echo esc_html($max_attachments); ?>
					</div>
					...
					<button type="button" id="select-attachments"
						class="btn btn-primary"><?php esc_html_e('Browse Attachments', 'framework'); ?></button>
				</div>
				<p id="attachments-max-upload" class="attachments-max-upload hide">
					<?php esc_html_e('You have reached maximum attachments upload limit.', 'framework'); ?></p>
...
if (!function_exists('inspiry_additional_details')) {
	...
	function inspiry_additional_details()
	{
		...
		<div class="inspiry-details-wrapper">
			...
			<button class="add-detail btn btn-primary"><i
