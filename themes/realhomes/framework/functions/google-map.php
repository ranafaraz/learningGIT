...
if (!function_exists('inspiry_enqueue_google_maps')) {
	...
	function inspiry_enqueue_google_maps()
	{
		if (inspiry_is_map_needed()) {
			...
			if ('classic' !== INSPIRY_DESIGN_VARIATION && 'google-maps' === inspiry_get_maps_type() && inspiry_is_rvr_enabled() && realhomes_is_location_type_geolocation()) {
			...
			if (is_singular('property') && ('true' == get_option('theme_display_google_map'))) {
				...
				is_page_template(array('templates/properties.php', 'templates/list-layout.php', 'templates/grid-layout.php', 'templates/list-layout-full-width.php', 'templates/grid-layout-full-width.php')) ||
...
if (!function_exists('inspiry_render_multi_properties_google_map')):
	...
	function inspiry_render_multi_properties_google_map()
	{
		...
		if ('all' != $properties_on_the_map) {
			...
			if (((is_page_template(array('templates/properties.php', 'templates/list-layout.php', 'templates/list-layout-full-width.php', 'templates/grid-layout.php', 'templates/grid-layout-full-width.php', 'templates/half-map-layout.php')) || is_tax()) && $ajax_pagination_enabled)) {
...
if (!function_exists('inspiry_render_property_google_map')):
	...
	function inspiry_render_property_google_map()
	{
		...
		if ($property_address && !empty($property_location) && (1 != $property_map)) {
			...
			$property_map_data['address'] = $property_address;
