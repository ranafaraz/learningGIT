...
//    ),
//    'floor'=> array(
//        'label' => get_option('inspiry_floor_field_label') ? esc_html(get_option('inspiry_floor_field_label')) : esc_html__('קומה', 'framework'),
//        'key' => 'REAL_HOMES_property_floor',
//        'icon' => 'ultra-floor',
//        'postfix' => 'REAL_HOMES_property_floor_postfix'
//    ),
//    'bathrooms' => array(
...
//    $array_replaced = array_intersect_key(array_replace($inspiry_meta_selection_flip, $settings_to_keys), $inspiry_meta_selection_flip);
    ...
    <div class="rh-properties-card-meta-ultra">
        <?php
//        foreach ($settings_to_keys as $meta) {
//            if (!empty($meta) && is_array($meta)) {
//                rh_ultra_meta($meta['label'], $meta['key'], $meta['icon'], $meta['postfix']);
//            }
//        }
        rh_ultra_meta('', 'REAL_HOMES_property_bedrooms', 'ultra-bedrooms', '');
