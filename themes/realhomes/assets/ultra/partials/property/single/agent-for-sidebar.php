			...
			<div class="rh-agent-title-wrapper">
				<div class="rh-agent-name-and-avatar-wrapper">
					...
					if (isset($args['display_author']) && ($args['display_author'])) {
						$user_post_id = get_user_meta(get_the_author_meta('ID'), 'inspiry_role_post_id', true);
						$user_post_url = get_permalink($user_post_id);
					} else {
				...
				<div class="rh-property-agent-enquiry-form rh-ultra-form">
					<form id="<?php echo esc_attr($agent_form_id); ?>" class="rh_widget_form agent-form" method="post"
						...
						<p class="rh_widget_form__row rh-ultra-form-field-wrapper">
							...
							<input id="rh-enquiry-name" type="text" name="name" placeholder="<?php esc_html_e('Name', 'framework'); ?>"
								class="required rh-ultra-field" title="<?php esc_html_e('* Please provide your name', 'framework'); ?>" />
						</p>
						<!-- /.rh_widget_form__row -->
						<p class="rh_widget_form__row rh-ultra-form-field-wrapper">
							...
							<input id="rh-enquiry-email" type="text" name="email" placeholder="<?php esc_html_e('Email', 'framework'); ?>"
						...
						<p class="rh_widget_form__row rh-ultra-form-field-wrapper">
							...
							<input id="rh-enquiry-phone" type="text" name="phone" placeholder="<?php esc_html_e('Phone', 'framework'); ?>"
								class="required rh-ultra-field"
						...
						<p class="rh_widget_form__row rh-ultra-form-field-wrapper rh-ultra-form-textarea">
							...
							<textarea id="rh-enquiry-message" cols="40" rows="6" name="message"
								placeholder="<?php esc_html_e('Message', 'framework'); ?>" class="required rh-ultra-field"
