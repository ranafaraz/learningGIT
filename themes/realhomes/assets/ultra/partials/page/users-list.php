							...
							<div class="agent-card-inner">
								...
								<div class="agent-details">
										...
										if (!empty($user_meta['office_number'][0])) {
											...
											<div class="agent-contact-item">
												...
												<div class="agent-contact-item-inner">
													...
													<a
														href="tel:<?php echo esc_attr(str_replace(' ', '', $user_meta['office_number'][0])); ?>"><?php echo esc_html($user_meta['office_number'][0]); ?></a>
												</div>
											</div>
											<?php
										}
										if (!empty($user_meta['fax_number'][0])) {
											...
											<div class="agent-contact-item">
												...
												<div class="agent-contact-item-inner">
													...
													<a
														href="tel:<?php echo esc_attr(str_replace(' ', '', $user_meta['fax_number'][0])); ?>"><?php echo esc_html($user_meta['fax_number'][0]); ?></a>
												</div>
											</div>
											<?php
										}
										if (!empty($user_meta['whatsapp_number'][0])) {
											...
											<div class="agent-contact-item">
												...
												<div class="agent-contact-item-inner">
													...
													<a
														href="tel:<?php echo esc_attr(str_replace(' ', '', $user_meta['whatsapp_number'][0])); ?>"><?php echo esc_html($user_meta['whatsapp_number'][0]); ?></a>
												</div>
											</div>
											<?php
										}
															...
															if (!empty($user->user_email)) {
																...
																<div class="agent-contact-item">
																	...
																	<div class="agent-contact-item-inner">
																		...
																		<a
																			href="mailto:<?php echo esc_attr(antispambot($user->user_email)); ?>"><?php echo esc_html(antispambot($user->user_email)); ?></a>
																	</div>
																</div>
																<?php
															}
									...
									<footer class="agent-card-footer">
										...
										if (
											!empty($user_meta['facebook_url'][0]) ||
										...
										?>
										<a class="agent-listing-count"
											href="<?php echo esc_url($author_page_url); ?>"><?php echo esc_html($listed_properties_text); ?>
