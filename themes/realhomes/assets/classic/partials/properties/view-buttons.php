...
<div class="view-type clearfix">
	...
	if ( isset( $_GET['view'] ) ) {
	    ...
	    if ( is_page_template( array( 'templates/grid-layout.php', 'templates/grid-layout-full-width.php' ) ) ) {
			$view_type = 'grid';
		}

		if ( is_page_template( array( 'templates/list-layout.php', 'templates/list-layout-full-width.php' ) ) ) {
			$view_type = 'list';
		}
	}
	?>
