...
if (!class_exists('Agents_List_Widget')) {
	...
	class Agents_List_Widget extends WP_Widget
	{
		...
		function widget($args, $instance)
		{
			...
			// Exclude agents who have post title starting with "agent_"
			$agent_args['s'] = '-agent_';
								...
								if (!empty($agent_contact_number)) {
									if ('ultra' === INSPIRY_DESIGN_VARIATION) {
										...
										<div class="rh-widget-agent-contact-item">
											...
											?>
											<a
												href="tel://<?php echo esc_attr($agent_contact_number); ?>"><?php echo esc_html($agent_contact_number); ?></a>
										</div>
										<?php
									} else {
										?>
		...
		function form($instance)
		{
			...
			<p>
				<label
					for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Widget Title', 'easy-real-estate'); ?></label>
			...
			<p>
				<label
					for="<?php echo esc_attr($this->get_field_id('count')); ?>"><?php esc_html_e('Number of Agents', 'easy-real-estate'); ?></label>
