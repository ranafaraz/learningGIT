...
if (!function_exists('rhea_display_agent_box')) {
	...
	function rhea_display_agent_box($args)
	{
		...
		?>
		<section
			class="rh-ultra-property-detail-agent rh_property_agent<?php echo esc_attr($agent_section_classes) . ' ' . (!empty($args['agent_class']) ? esc_attr($args['agent_class']) : ''); ?>">
						...
						<div class="rh-agent-title-wrapper">
							...
							if (!empty($settings['agent_know_more'])) {
								...
								<a class="rh-property-agent-link"
									href="<?php echo esc_url($agent_url) ?>"><?php echo esc_html($settings['agent_know_more']); ?></a>
								<?php
							}
							?>
						</div>
				...
				if (inspiry_get_agent_custom_form($args['agent_id'])) {
					...
					?>
						<div class="rh-property-agent-enquiry-form rh-ultra-form">
							<form id="<?php echo esc_attr($agent_form_id); ?>" class="rh_widget_form agent-form" method="post"
								...
								<div class="rh-ultra-fields-split">
									<p class="rh_widget_form__row rh-ultra-form-field-wrapper">
										...
										<input id="rh-enquiry-name" type="text" name="name"
											placeholder="<?php echo esc_html($settings['agent_name_placeholder']); ?>" class="required rh-ultra-field"
											title="<?php esc_html_e('* Please provide your name', 'realhomes-elementor-addon'); ?>" />
									</p>
									<p class="rh_widget_form__row rh-ultra-form-field-wrapper">
										<label for="rh-enquiry-email">
										<?php inspiry_safe_include_svg('/ultra/icons/email.svg', '/assets/'); ?>
										</label>
										<input id="rh-enquiry-email" type="text" name="email"
											placeholder="<?php echo esc_html($settings['agent_email_placeholder']); ?>"
											class="required rh-ultra-field"
											title="<?php esc_html_e('* Please provide valid email address', 'realhomes-elementor-addon'); ?>" />
									</p>
								</div>
								<p class="rh_widget_form__row rh-ultra-form-field-wrapper">
									...
									<input id="rh-enquiry-phone" type="text" name="phone"
										placeholder="<?php echo esc_html($settings['agent_phone_placeholder']); ?>" class="required rh-ultra-field"
										title="<?php esc_html_e('* Please provide valid phone number', 'realhomes-elementor-addon'); ?>" />
								</p>
								<p class="rh_widget_form__row rh-ultra-form-field-wrapper rh-ultra-form-textarea">
									...
									<textarea id="rh-enquiry-message" cols="40" rows="6" name="message"
										placeholder="<?php echo esc_html($settings['agent_textarea_placeholder']); ?>"
										class="required rh-ultra-field"
										title="<?php esc_html_e('* Please provide your message', 'realhomes-elementor-addon'); ?>"><?php
								...
								<input type="hidden" name="property_permalink"
									value="<?php echo esc_url_raw(get_permalink($rhea_post_id)); ?>" />
								<button type="submit" name="submit" class="rh-ultra-filled-button rh-ultra-button submit-button">
									...
									<span id="ajax-loader-<?php echo esc_attr($agent_form_id); ?>"
										class="ajax-loader"><?php inspiry_safe_include_svg('/icons/ball-triangle.svg'); ?></span>
								</button>
