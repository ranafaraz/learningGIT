(function ($) {
    ...
    window.minMaxFloorValidation = function (minID, maxID) {

        /**
         * Max and Min Floor
         * Shows red outline if min floor is bigger than max floor
         */
    ...
    window.rheaLocationsHandler = function (hierarchicalLocations,
                                            ...
                                            selectBoxesCount,
                                            anyValue,
                                            multiSelect, selectedLocationFromPageTitle) {
            ...
            for (let selectIndex = 0; selectIndex < selectBoxesCount; selectIndex++) {
                ...
                if (parentLocations.length === 0) {
                    ...
                    if (selectedLocationFromPageTitle !== '') {
                        selectParamOption(currentSelect, selectedLocationFromPageTitle);
                    } else {
