	...
	protected function render()
	{
		...
		<div class="rhea_ultra_search_form_wrapper" id="rhea-<?php echo esc_attr($the_widget_id); ?>">
			<form class="rhea_search_form advance-search-form"
				...
				if (
					('yes' === $show_status_in_tabs && 'top' === $settings['status_tabs_display_location']) ||
					...
					<div class="rhea-ultra-search-form-inner">
						<div class="rhea_top_search_fields">
							<div class="rhea_top_search_box <?php echo esc_attr('rhea_top_fields_count_' . $rhea_top_field_count) ?>"
								id="top-<?php echo esc_attr($the_widget_id); ?>">
								<?php
										...
										if (in_array($field_key, $search_fields_to_display)) {
											...
											if (in_array($additional_field['field_type'], array('text', 'textarea'))) {
												...
												<div class="rhea_prop_search__option rhea_mod_text_field"
													data-key-position="<?php echo esc_attr($field_position); ?>"
													style="order: <?php echo esc_attr($field_position); ?>">
													<?php
													if ('yes' === $settings['show_labels']) {
														?>
														<label class="rhea_fields_labels"
															for="<?php echo esc_attr($field_id); ?>"><?php echo esc_html($field_name); ?></label>
														<?php
													}
													?>
													<span class="rhea-text-field-wrapper">
														<input type="text" name="<?php echo esc_attr($field_key); ?>"
															...
															value="<?php echo isset($_GET[$field_key]) ? esc_attr($_GET[$field_key]) : ''; ?>"
						...
						<div
							class="rhea_collapsed_search_fields  rhea_advance_fields_<?php echo esc_attr($settings['rhea_default_advance_state']) ?>"
							id="collapsed_wrapper_<?php echo esc_attr($the_widget_id); ?>">
							<div class="rhea_collapsed_search_fields_inner" id="collapsed-<?php echo esc_attr($the_widget_id); ?>">
							</div>
						</div>
		...
		if (\Elementor\Plugin::$instance->editor->is_edit_mode()) {
			...
			<script type="application/javascript">
				...
				minMaxFloorValidation("#select-min-floor-<?php echo esc_attr($the_widget_id); ?>", "#select-max-floor-<?php echo esc_attr($the_widget_id); ?>");
