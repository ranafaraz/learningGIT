...
//					'{{WRAPPER}} .rhea_collapsed_search_fields_inner .rhea_prop_search__option' => 'width: {{SIZE}}{{UNIT}};',
		...
		$this->SF_fields_icons( 'enable_location_icon', 'location_icon' );
		...
		if ( $this->is_rvr_enabled ) {
			...
			$this->SF_fields_icons( 'enable_check_in_out_icon', 'check_in_out_icon' );
			...
			$this->SF_fields_icons( 'enable_guests_icon', 'guests_icon' );
		...
		$this->SF_fields_icons( 'enable_status_icon', 'status_icon' );
		$this->end_controls_section();
		$this->start_controls_section(
		...
		$this->SF_fields_icons( 'enable_type_icon', 'type_icon' );
		$this->end_controls_section();
		...
		$this->SF_fields_icons( 'enable_min_beds_icon', 'min_beds_icon' );
		...
		$this->SF_fields_icons( 'enable_min_baths_icon', 'min_baths_icon' );
		...
		$this->SF_fields_icons( 'enable_min_price_icon', 'min_price_icon' );
		$this->SF_fields_icons( 'enable_max_price_icon', 'max_price_icon' );
		...
		$this->SF_fields_icons( 'enable_garages_icon', 'garages_icon' );
		$this->end_controls_section();
		...
		$this->SF_fields_icons( 'enable_agency_icon', 'agency_icon' );
		$this->end_controls_section();
		...
		$this->SF_fields_icons( 'enable_agent_icon', 'agent_icon' );
		$this->end_controls_section();
		...
		$this->SF_fields_icons( 'enable_min_area_icon', 'min_area_icon' );
		$this->SF_fields_icons( 'enable_max_area_icon', 'max_area_icon' );
		$this->end_controls_section();
		...
		$this->SF_fields_icons( 'enable_min_lot_icon', 'min_lot_icon' );
		$this->SF_fields_icons( 'enable_max_lot_icon', 'max_lot_icon' );
		...
		$this->SF_fields_icons( 'enable_keywords_icon', 'keywords_icon' );
		$this->end_controls_section();
		...
		$this->SF_fields_icons( 'enable_id_icon', 'id_icon' );
		$this->end_controls_section();
		...
		$this->SF_fields_icons( 'enable_features_icon', 'features_icon' );
		$this->end_controls_section();
	...
	protected function render() {
		...
		?>
        <div class="rhea_search_form_wrapper rhea-dropdown-style-<?php echo esc_attr( $settings['dropdown-icon-style'] ); ?>" id="rhea-<?php echo esc_attr( $the_widget_id ); ?>">
                ...
                <div class="rhea-search-form-frame <?php echo esc_attr( $tabs_enable_class ) ?>">
                    <div class="rhea_top_search_fields">
                        <div class="rhea_top_search_box <?php echo esc_attr( 'rhea_top_fields_count_' . $rhea_top_field_count ) ?>" id="top-<?php echo esc_attr( $this->get_id() ); ?>">
							...
							rhea_get_template_part('elementor/widgets/search/fields/min-max-floor');
										...
										if ( in_array( $additional_field['field_type'], array( 'text', 'textarea' ) ) ) {
                                            ...
                                            <div class="rhea_prop_search__option rhea_prop_search__select" data-key-position="<?php echo esc_attr( $field_position ); ?>" style="order: <?php echo esc_attr( $field_position ); ?>">
                                                ...
                                                <span class="rhea_prop_search__selectwrap">
                                                        <select id="<?php echo esc_attr( $field_id ); ?>" name="<?php echo esc_attr( $field_key ); ?>" class="rhea_multi_select_picker selectpicker show-tick">
                                                            <?php
                                                            ...
                                                            if ( ! empty( $options ) && is_array( $options ) ) {
	                                                            foreach ( $options as $option ) {
		                                                            $selected = ( ! empty( $_GET[ $field_key ] ) && ( $_GET[ $field_key ] === $option ) ) ? 'selected="selected"' : '';
